...
namespace OOP
{
    public class Rectangle
    {
        ...
        /*
         * About properties can make benefits
         * - avoid entering invalid state of objects of class 
         * -the implementation details of class, (abstraction)
         * -property avoid these two issuse
         */
